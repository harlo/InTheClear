...
package info.guardianproject.intheclear.screens;
...
import info.guardianproject.intheclear.ui.WipeArrayAdaptor;
import info.guardianproject.intheclear.ui.WipeSelector;
import info.guardianproject.intheclear.ui.WipeSelector.Color;
...
public class WipePreferences extends Activity implements OnClickListener {
    ...
    boolean defaultContacts, defaultPhotos, defaultCallLog, defaultSMS, defaultCalendar,
            defaultSDCard = false;
    ...
    public void onCreate(Bundle savedInstanceState) {
         ...
         * (which would be passed in as a bundle) we must automatically populate
         * them here
         */
        try {
            if (getIntent().getSerializableExtra(ITCConstants.Preference.WIPE_SELECTOR) != null) {
                Map<Integer, Boolean> wipePreferences =
                        ((ArrayList<Map<Integer, Boolean>>) getIntent().getSerializableExtra(
                                ITCConstants.Preference.WIPE_SELECTOR)).get(0);
